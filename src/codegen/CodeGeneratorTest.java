...
public class CodeGeneratorTest {
    ...
    public void verysimplemultithreads() {
        Function inc = new Function(Type.Int, "inc", new Parameter[]{}, new Declaration[]{},
                new Statement[]{new Return(new Number(42))});
        ...
        Function main = new Function(Type.Int, "main", new Parameter[]{}, new Declaration[]{
                ...
                Assignment("t1", new Call("inc", new Expression[]{}, true)), new Assignment("t2", new
                Call("inc", new Expression[]{}, true)), new Assignment("x", new Join(new
                Variable("t1"))), new Assignment("x", new Binary(new Variable("x"), Binop.Plus, new
                Join(new Variable("t2")))), new Return(new Variable("x"))});
    ...
    public void testDeadlock(){
        Function main = new Function(Type.Int, "main", new Parameter[] { }, new Declaration[] {
                ...
                Assignment("array1", new ArrayAllocator(new Number(5))), new Assignment("array2", new
                ArrayAllocator(new Number(3))), new Assignment("back1", new Call("firstexecuter", new
                Expression[] { new Variable("array1"), new Variable("array2") }, true)), new
                Assignment("back2", new Call("secondexecuter", new Expression[] { new Variable("array1"),
                new Variable("array2") }, true)), new Assignment("back1", new Join(new
                Variable("back1"))), new Assignment("back2", new Join(new Variable("back2"))), new
                Return(new Binary(new Variable("back1"), Binop.Plus, new Variable("back2"))) });
        ...
        Function firstexecuter = new Function(Type.Int, "firstexecuter", new Parameter[] { new
                ...
                Number(1)), new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus, new
                Number(1))), new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus,
                new Number(1))), new Assignment("counter", new Binary(new Variable("counter"),
                Binop.Plus, new Number(1))), new Synchronized(new Variable("lock2"), new Statement[] {
                new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus, new
                        Number(1))), new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus,
                new Number(1))), new Assignment("counter", new Binary(new Variable("counter"),
                Binop.Plus, new Number(1))) }) }), new Return(new Variable("counter")) });
        ...
        Function secondexecuter = new Function(Type.Int, "secondexecuter", new Parameter[] { new
                ...
                Number(1))), new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus,
                new Number(1))), new Assignment("counter", new Binary(new Variable("counter"),
                Binop.Plus, new Number(1))), new Synchronized(new Variable("lock1"), new Statement[] {
                new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus, new
                        Number(1))), new Assignment("counter", new Binary(new Variable("counter"), Binop.Plus,
                new Number(1))), new Assignment("counter", new Binary(new Variable("counter"),
                Binop.Plus, new Number(1))) }) }), new Return(new Variable("counter")) });
        ...
        Program program = new Program( new Function[] { main, firstexecuter, secondexecuter } );
        runProgram(program);
    ...
    public void testracecondition() {
        Function inc = new Function(Type.Int, "inc", new Parameter[]{new
                ...
                ArrayIndexAssignment(new Variable("array"), new Number(0), new Binary(new ArrayAccess(new
                Variable("array"), new Number(0)), Binop.Plus, new Number(1))), new Return(new
                Number(42))});
    ...
    //************** Ende Aufgabenstellung 13.4 ***************************

    @Test//(expected = IllegalHeapAccessException.class)
    public void arraycatastrophie() throws InterruptedException {
        Function main = new Function(Type.Int, "main", new Parameter[]{}, new Declaration[]{
                new Declaration(Type.IntArray, "array")}, new Statement[]{new Assignment("array", new
                ArrayAllocator(new Number(4))), new ArrayIndexAssignment(new Variable("array"), new
                Number(0), new Number(2)), new ArrayIndexAssignment(new Variable("array"), new Number(1),
                new Number(4)), new ArrayIndexAssignment(new Variable("array"), new Number(2), new
                Number(6)), new ArrayIndexAssignment(new Variable("array"), new Number(3), new
                Number(8)), new Return(new ArrayAccess(new Variable("array"), new Number(3)))});


        Program program = new Program(new Function[]{main});
        runProgram(program);
        testProgram(program, 8);
    }
    ...
    public void testArrayExpr() {
        ...
        Function main = new Function("main", new String[]{},
                ...
                new Statement[]{
                        new Return(new ArrayAccess(new Call("init", new Expression[]{new Number(25)}), new Binary(new Number(i), Binop.Plus, new Number(j))))
                });
...
//    System.out.println(fv.getFormattedCode());
    ...
    public void testArrayLength() {
        ...
        Function sum = new Function(Type.Int, "sum", new Parameter[]{new Parameter(Type.IntArray, "array")},
                new Declaration[]{}, new Statement[]{
                new Return(new Call("sumRec", new Expression[]{new Variable("array"), new Number(0)}))
        });
        ...
        Function main = new Function("main", new String[]{},
                new Declaration[]{new Declaration(Type.IntArray, "a")},
                new Statement[]{
                        new Assignment("a", new Call("init", new Expression[]{new Number(size)})),
            ...
            Function main = new Function(Type.Int, "main", new Parameter[]{},
                    ...
                    new Statement[]{
                            ...
                            new ExpressionStatement(
                                    new Call("mergeSort",
                                            new Expression[]{new Variable("arr"), new Number(0), new Binary(new ArrayLength(new Variable("arr")), Binop.Minus, new Number(1))})),
    ...
    public void testArraySheetExample() {
        ...
        Function main = new Function("main", new String[]{},
                new Declaration[]{new Declaration(Type.IntArray, "a")},
                new Statement[]{
                        new Assignment("a", new Call("init", new Expression[]{new Read()})),
                        new Return(new Call("sum", new Expression[]{new Variable("a")}))
                });
