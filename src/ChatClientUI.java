...
public class ChatClientUI extends Frame implements ChatClientMessageSenderThread {
    ...
    public ChatClientUI() {
        ...
        Label title = new Label("CHAOS CHAT", Label.CENTER);
        //title.setFont(new Font("Sa", Font.BOLD, 14));
        obj.add("North", title);

        TextField field = new TextField();


        obj.add("Center", field);

        Panel actionconsole = new Panel();

        TextField inputarea = new TextField();

        actionconsole.add("Center", inputarea);
        actionconsole.add("East", sendButton);
        actionconsole.add("South", quitButton);


        obj.add("South", actionconsole);
